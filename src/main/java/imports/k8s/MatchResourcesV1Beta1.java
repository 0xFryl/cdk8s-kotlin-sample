 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.106.0 (build e852934)", date = "2024-12-21T20:14:29.686Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.MatchResourcesV1Beta1")
@software.amazon.jsii.Jsii.Proxy(MatchResourcesV1Beta1.Jsii$Proxy.class)
public interface MatchResourcesV1Beta1 extends software.amazon.jsii.JsiiSerializable {
     ...
     * The exclude rules take precedence over include rules (if a resource matches both, it is excluded)
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1> getExcludeResourceRules() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1> getResourceRules() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link MatchResourcesV1Beta1}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link MatchResourcesV1Beta1}
     */
    public static final class Builder implements software.amazon.jsii.Builder<MatchResourcesV1Beta1> {
        java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1> excludeResourceRules;
        java.lang.String matchPolicy;
        imports.k8s.LabelSelector namespaceSelector;
        imports.k8s.LabelSelector objectSelector;
        java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1> resourceRules;

        /**
         * Sets the value of {@link MatchResourcesV1Beta1#getExcludeResourceRules}
        ...
        public Builder excludeResourceRules(java.util.List<? extends imports.k8s.NamedRuleWithOperationsV1Beta1> excludeResourceRules) {
            this.excludeResourceRules = (java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1>)excludeResourceRules;
            return this;
        }

        /**
         * Sets the value of {@link MatchResourcesV1Beta1#getMatchPolicy}
        ...
        /**
         * Sets the value of {@link MatchResourcesV1Beta1#getNamespaceSelector}
        ...
        /**
         * Sets the value of {@link MatchResourcesV1Beta1#getObjectSelector}
        ...
        /**
         * Sets the value of {@link MatchResourcesV1Beta1#getResourceRules}
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder resourceRules(java.util.List<? extends imports.k8s.NamedRuleWithOperationsV1Beta1> resourceRules) {
            this.resourceRules = (java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1>)resourceRules;
            return this;
        }

        /**
         * Builds the configured instance.
         * @return a new instance of {@link MatchResourcesV1Beta1}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public MatchResourcesV1Beta1 build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link MatchResourcesV1Beta1}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements MatchResourcesV1Beta1 {
        private final java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1> excludeResourceRules;
        ...
        private final java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1> resourceRules;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.excludeResourceRules = software.amazon.jsii.Kernel.get(this, "excludeResourceRules", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.NamedRuleWithOperationsV1Beta1.class)));
            ...
            this.resourceRules = software.amazon.jsii.Kernel.get(this, "resourceRules", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.NamedRuleWithOperationsV1Beta1.class)));
        }
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.excludeResourceRules = (java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1>)builder.excludeResourceRules;
            ...
            this.resourceRules = (java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1>)builder.resourceRules;
        }

        @Override
        public final java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1> getExcludeResourceRules() {
        ...
        @Override
        public final java.util.List<imports.k8s.NamedRuleWithOperationsV1Beta1> getResourceRules() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("k8s.MatchResourcesV1Beta1"));
        ...
        public final boolean equals(final Object o) {
            ...
            MatchResourcesV1Beta1.Jsii$Proxy that = (MatchResourcesV1Beta1.Jsii$Proxy) o;
