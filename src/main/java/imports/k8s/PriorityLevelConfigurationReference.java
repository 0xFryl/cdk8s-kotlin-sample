...
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.PriorityLevelConfigurationReference")
...
public interface PriorityLevelConfigurationReference extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    public static final class Builder implements software.amazon.jsii.Builder<PriorityLevelConfigurationReference> {
