 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.106.0 (build e852934)", date = "2024-12-21T20:14:29.752Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.ValidatingAdmissionPolicyBindingSpec")
@software.amazon.jsii.Jsii.Proxy(ValidatingAdmissionPolicyBindingSpec.Jsii$Proxy.class)
public interface ValidatingAdmissionPolicyBindingSpec extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.MatchResources getMatchResources() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.ParamRef getParamRef() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ValidatingAdmissionPolicyBindingSpec}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ValidatingAdmissionPolicyBindingSpec}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ValidatingAdmissionPolicyBindingSpec> {
        imports.k8s.MatchResources matchResources;
        imports.k8s.ParamRef paramRef;
        java.lang.String policyName;
        java.util.List<java.lang.String> validationActions;

        /**
         * Sets the value of {@link ValidatingAdmissionPolicyBindingSpec#getMatchResources}
         * @param matchResources MatchResources declares what resources match this binding and will be validated by it.
         *                       Note that this is intersected with the policy's matchConstraints, so only requests that are matched by the policy can be selected by this. If this is unset, all resources matched by the policy are validated by this binding When resourceRules is unset, it does not constrain resource matching. If a resource is matched by the other fields of this object, it will be validated. Note that this is differs from ValidatingAdmissionPolicy matchConstraints, where resourceRules are required.
         * @return {@code this}
         */
        public Builder matchResources(imports.k8s.MatchResources matchResources) {
            this.matchResources = matchResources;
            return this;
        }

        /**
         * Sets the value of {@link ValidatingAdmissionPolicyBindingSpec#getParamRef}
         * @param paramRef paramRef specifies the parameter resource used to configure the admission control policy.
         *                 It should point to a resource of the type specified in ParamKind of the bound ValidatingAdmissionPolicy. If the policy specifies a ParamKind and the resource referred to by ParamRef does not exist, this binding is considered mis-configured and the FailurePolicy of the ValidatingAdmissionPolicy applied. If the policy does not specify a ParamKind then this field is ignored, and the rules are evaluated without a param.
         * @return {@code this}
         */
        public Builder paramRef(imports.k8s.ParamRef paramRef) {
            this.paramRef = paramRef;
            return this;
        }

        /**
         * Sets the value of {@link ValidatingAdmissionPolicyBindingSpec#getPolicyName}
        ...
        /**
         * Sets the value of {@link ValidatingAdmissionPolicyBindingSpec#getValidationActions}
         ...
         * @return a new instance of {@link ValidatingAdmissionPolicyBindingSpec}
    ...
    /**
     * An implementation for {@link ValidatingAdmissionPolicyBindingSpec}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ValidatingAdmissionPolicyBindingSpec {
        private final imports.k8s.MatchResources matchResources;
        private final imports.k8s.ParamRef paramRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.matchResources = software.amazon.jsii.Kernel.get(this, "matchResources", software.amazon.jsii.NativeType.forClass(imports.k8s.MatchResources.class));
            this.paramRef = software.amazon.jsii.Kernel.get(this, "paramRef", software.amazon.jsii.NativeType.forClass(imports.k8s.ParamRef.class));
        ...
        @Override
        public final imports.k8s.MatchResources getMatchResources() {
            return this.matchResources;
        }

        @Override
        public final imports.k8s.ParamRef getParamRef() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("k8s.ValidatingAdmissionPolicyBindingSpec"));
        ...
        public final boolean equals(final Object o) {
            ...
            ValidatingAdmissionPolicyBindingSpec.Jsii$Proxy that = (ValidatingAdmissionPolicyBindingSpec.Jsii$Proxy) o;
