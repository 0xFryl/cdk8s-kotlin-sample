...
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.ValidatingAdmissionPolicyBindingSpecV1Beta1")
@software.amazon.jsii.Jsii.Proxy(ValidatingAdmissionPolicyBindingSpecV1Beta1.Jsii$Proxy.class)
public interface ValidatingAdmissionPolicyBindingSpecV1Beta1 extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.MatchResourcesV1Beta1 getMatchResources() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.ParamRefV1Beta1 getParamRef() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ValidatingAdmissionPolicyBindingSpecV1Beta1}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ValidatingAdmissionPolicyBindingSpecV1Beta1}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ValidatingAdmissionPolicyBindingSpecV1Beta1> {
        imports.k8s.MatchResourcesV1Beta1 matchResources;
        imports.k8s.ParamRefV1Beta1 paramRef;
        java.lang.String policyName;
        java.util.List<java.lang.String> validationActions;

        /**
         * Sets the value of {@link ValidatingAdmissionPolicyBindingSpecV1Beta1#getMatchResources}
         * @param matchResources MatchResources declares what resources match this binding and will be validated by it.
         *                       Note that this is intersected with the policy's matchConstraints, so only requests that are matched by the policy can be selected by this. If this is unset, all resources matched by the policy are validated by this binding When resourceRules is unset, it does not constrain resource matching. If a resource is matched by the other fields of this object, it will be validated. Note that this is differs from ValidatingAdmissionPolicy matchConstraints, where resourceRules are required.
         * @return {@code this}
         */
        public Builder matchResources(imports.k8s.MatchResourcesV1Beta1 matchResources) {
            this.matchResources = matchResources;
            return this;
        }

        /**
         * Sets the value of {@link ValidatingAdmissionPolicyBindingSpecV1Beta1#getParamRef}
         * @param paramRef paramRef specifies the parameter resource used to configure the admission control policy.
         *                 It should point to a resource of the type specified in ParamKind of the bound ValidatingAdmissionPolicy. If the policy specifies a ParamKind and the resource referred to by ParamRef does not exist, this binding is considered mis-configured and the FailurePolicy of the ValidatingAdmissionPolicy applied. If the policy does not specify a ParamKind then this field is ignored, and the rules are evaluated without a param.
         * @return {@code this}
         */
        public Builder paramRef(imports.k8s.ParamRefV1Beta1 paramRef) {
            this.paramRef = paramRef;
            return this;
        }

        /**
         * Sets the value of {@link ValidatingAdmissionPolicyBindingSpecV1Beta1#getPolicyName}
        ...
        /**
         * Sets the value of {@link ValidatingAdmissionPolicyBindingSpecV1Beta1#getValidationActions}
         ...
         * @return a new instance of {@link ValidatingAdmissionPolicyBindingSpecV1Beta1}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ValidatingAdmissionPolicyBindingSpecV1Beta1 build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ValidatingAdmissionPolicyBindingSpecV1Beta1}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ValidatingAdmissionPolicyBindingSpecV1Beta1 {
        private final imports.k8s.MatchResourcesV1Beta1 matchResources;
        private final imports.k8s.ParamRefV1Beta1 paramRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.matchResources = software.amazon.jsii.Kernel.get(this, "matchResources", software.amazon.jsii.NativeType.forClass(imports.k8s.MatchResourcesV1Beta1.class));
            this.paramRef = software.amazon.jsii.Kernel.get(this, "paramRef", software.amazon.jsii.NativeType.forClass(imports.k8s.ParamRefV1Beta1.class));
        ...
        @Override
        public final imports.k8s.MatchResourcesV1Beta1 getMatchResources() {
            return this.matchResources;
        }

        @Override
        public final imports.k8s.ParamRefV1Beta1 getParamRef() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("k8s.ValidatingAdmissionPolicyBindingSpecV1Beta1"));
        ...
        public final boolean equals(final Object o) {
            ...
            ValidatingAdmissionPolicyBindingSpecV1Beta1.Jsii$Proxy that = (ValidatingAdmissionPolicyBindingSpecV1Beta1.Jsii$Proxy) o;
