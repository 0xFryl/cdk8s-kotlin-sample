...
public interface ValidatingAdmissionPolicySpecV1Alpha1 extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.AuditAnnotationV1Alpha1> getAuditAnnotations() {
        return null;
    }
     ...
     * </ul>
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.MatchConditionV1Alpha1> getMatchConditions() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.ValidationV1Alpha1> getValidations() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.VariableV1Alpha1> getVariables() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ValidatingAdmissionPolicySpecV1Alpha1> {
        java.util.List<imports.k8s.AuditAnnotationV1Alpha1> auditAnnotations;
        java.lang.String failurePolicy;
        java.util.List<imports.k8s.MatchConditionV1Alpha1> matchConditions;
        ...
        java.util.List<imports.k8s.VariableV1Alpha1> variables;

        /**
         * Sets the value of {@link ValidatingAdmissionPolicySpecV1Alpha1#getAuditAnnotations}
        ...
        public Builder auditAnnotations(java.util.List<? extends imports.k8s.AuditAnnotationV1Alpha1> auditAnnotations) {
            this.auditAnnotations = (java.util.List<imports.k8s.AuditAnnotationV1Alpha1>)auditAnnotations;
            return this;
        }
        ...
        /**
         * Sets the value of {@link ValidatingAdmissionPolicySpecV1Alpha1#getMatchConditions}
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder matchConditions(java.util.List<? extends imports.k8s.MatchConditionV1Alpha1> matchConditions) {
            this.matchConditions = (java.util.List<imports.k8s.MatchConditionV1Alpha1>)matchConditions;
            return this;
        }
        ...
        /**
         * Sets the value of {@link ValidatingAdmissionPolicySpecV1Alpha1#getVariables}
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder variables(java.util.List<? extends imports.k8s.VariableV1Alpha1> variables) {
            this.variables = (java.util.List<imports.k8s.VariableV1Alpha1>)variables;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ValidatingAdmissionPolicySpecV1Alpha1 {
        private final java.util.List<imports.k8s.AuditAnnotationV1Alpha1> auditAnnotations;
        private final java.lang.String failurePolicy;
        private final java.util.List<imports.k8s.MatchConditionV1Alpha1> matchConditions;
        ...
        private final java.util.List<imports.k8s.VariableV1Alpha1> variables;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.auditAnnotations = software.amazon.jsii.Kernel.get(this, "auditAnnotations", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.AuditAnnotationV1Alpha1.class)));
            ...
            this.matchConditions = software.amazon.jsii.Kernel.get(this, "matchConditions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.MatchConditionV1Alpha1.class)));
            ...
            this.variables = software.amazon.jsii.Kernel.get(this, "variables", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.VariableV1Alpha1.class)));
        }
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.auditAnnotations = (java.util.List<imports.k8s.AuditAnnotationV1Alpha1>)builder.auditAnnotations;
            this.failurePolicy = builder.failurePolicy;
            this.matchConditions = (java.util.List<imports.k8s.MatchConditionV1Alpha1>)builder.matchConditions;
            this.matchConstraints = builder.matchConstraints;
            this.paramKind = builder.paramKind;
            this.validations = (java.util.List<imports.k8s.ValidationV1Alpha1>)builder.validations;
            this.variables = (java.util.List<imports.k8s.VariableV1Alpha1>)builder.variables;
        }

        @Override
        public final java.util.List<imports.k8s.AuditAnnotationV1Alpha1> getAuditAnnotations() {
        ...
        @Override
        public final java.util.List<imports.k8s.MatchConditionV1Alpha1> getMatchConditions() {
        ...
        @Override
        public final java.util.List<imports.k8s.VariableV1Alpha1> getVariables() {
