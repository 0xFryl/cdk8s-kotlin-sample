 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.106.0 (build e852934)", date = "2024-12-21T20:14:29.684Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.MatchResources")
@software.amazon.jsii.Jsii.Proxy(MatchResources.Jsii$Proxy.class)
public interface MatchResources extends software.amazon.jsii.JsiiSerializable {
     ...
     * The exclude rules take precedence over include rules (if a resource matches both, it is excluded)
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.NamedRuleWithOperations> getExcludeResourceRules() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.NamedRuleWithOperations> getResourceRules() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link MatchResources}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link MatchResources}
     */
    public static final class Builder implements software.amazon.jsii.Builder<MatchResources> {
        java.util.List<imports.k8s.NamedRuleWithOperations> excludeResourceRules;
        java.lang.String matchPolicy;
        imports.k8s.LabelSelector namespaceSelector;
        imports.k8s.LabelSelector objectSelector;
        java.util.List<imports.k8s.NamedRuleWithOperations> resourceRules;

        /**
         * Sets the value of {@link MatchResources#getExcludeResourceRules}
        ...
        public Builder excludeResourceRules(java.util.List<? extends imports.k8s.NamedRuleWithOperations> excludeResourceRules) {
            this.excludeResourceRules = (java.util.List<imports.k8s.NamedRuleWithOperations>)excludeResourceRules;
            return this;
        }

        /**
         * Sets the value of {@link MatchResources#getMatchPolicy}
        ...
        /**
         * Sets the value of {@link MatchResources#getNamespaceSelector}
        ...
        /**
         * Sets the value of {@link MatchResources#getObjectSelector}
        ...
        /**
         * Sets the value of {@link MatchResources#getResourceRules}
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder resourceRules(java.util.List<? extends imports.k8s.NamedRuleWithOperations> resourceRules) {
            this.resourceRules = (java.util.List<imports.k8s.NamedRuleWithOperations>)resourceRules;
            return this;
        }

        /**
         * Builds the configured instance.
         * @return a new instance of {@link MatchResources}
    ...
    /**
     * An implementation for {@link MatchResources}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements MatchResources {
        private final java.util.List<imports.k8s.NamedRuleWithOperations> excludeResourceRules;
        ...
        private final java.util.List<imports.k8s.NamedRuleWithOperations> resourceRules;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.excludeResourceRules = software.amazon.jsii.Kernel.get(this, "excludeResourceRules", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.NamedRuleWithOperations.class)));
            ...
            this.resourceRules = software.amazon.jsii.Kernel.get(this, "resourceRules", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.NamedRuleWithOperations.class)));
        }
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.excludeResourceRules = (java.util.List<imports.k8s.NamedRuleWithOperations>)builder.excludeResourceRules;
            ...
            this.resourceRules = (java.util.List<imports.k8s.NamedRuleWithOperations>)builder.resourceRules;
        }

        @Override
        public final java.util.List<imports.k8s.NamedRuleWithOperations> getExcludeResourceRules() {
        ...
        @Override
        public final java.util.List<imports.k8s.NamedRuleWithOperations> getResourceRules() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("k8s.MatchResources"));
        ...
        public final boolean equals(final Object o) {
            ...
            MatchResources.Jsii$Proxy that = (MatchResources.Jsii$Proxy) o;
