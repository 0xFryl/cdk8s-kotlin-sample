 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.106.0 (build e852934)", date = "2024-12-21T20:14:29.508Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.FlowSchemaSpec")
...
public interface FlowSchemaSpec extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.k8s.PriorityLevelConfigurationReference getPriorityLevelConfiguration();
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.FlowDistinguisherMethod getDistinguisherMethod() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.PolicyRulesWithSubjects> getRules() {
        return null;
    }
     ...
     */
    public static final class Builder implements software.amazon.jsii.Builder<FlowSchemaSpec> {
        imports.k8s.PriorityLevelConfigurationReference priorityLevelConfiguration;
        imports.k8s.FlowDistinguisherMethod distinguisherMethod;
        java.lang.Number matchingPrecedence;
        java.util.List<imports.k8s.PolicyRulesWithSubjects> rules;
         ...
         * @return {@code this}
         */
        public Builder priorityLevelConfiguration(imports.k8s.PriorityLevelConfigurationReference priorityLevelConfiguration) {
         ...
         * @return {@code this}
         */
        public Builder distinguisherMethod(imports.k8s.FlowDistinguisherMethod distinguisherMethod) {
        ...
        public Builder rules(java.util.List<? extends imports.k8s.PolicyRulesWithSubjects> rules) {
            this.rules = (java.util.List<imports.k8s.PolicyRulesWithSubjects>)rules;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements FlowSchemaSpec {
        private final imports.k8s.PriorityLevelConfigurationReference priorityLevelConfiguration;
        private final imports.k8s.FlowDistinguisherMethod distinguisherMethod;
        private final java.lang.Number matchingPrecedence;
        private final java.util.List<imports.k8s.PolicyRulesWithSubjects> rules;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.priorityLevelConfiguration = software.amazon.jsii.Kernel.get(this, "priorityLevelConfiguration", software.amazon.jsii.NativeType.forClass(imports.k8s.PriorityLevelConfigurationReference.class));
            this.distinguisherMethod = software.amazon.jsii.Kernel.get(this, "distinguisherMethod", software.amazon.jsii.NativeType.forClass(imports.k8s.FlowDistinguisherMethod.class));
            ...
            this.rules = software.amazon.jsii.Kernel.get(this, "rules", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.PolicyRulesWithSubjects.class)));
        }
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.rules = (java.util.List<imports.k8s.PolicyRulesWithSubjects>)builder.rules;
        }

        @Override
        public final imports.k8s.PriorityLevelConfigurationReference getPriorityLevelConfiguration() {
            return this.priorityLevelConfiguration;
        }

        @Override
        public final imports.k8s.FlowDistinguisherMethod getDistinguisherMethod() {
        ...
        @Override
        public final java.util.List<imports.k8s.PolicyRulesWithSubjects> getRules() {
            return this.rules;
        }
