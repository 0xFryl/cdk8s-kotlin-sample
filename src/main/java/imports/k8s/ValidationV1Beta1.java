 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.106.0 (build e852934)", date = "2024-12-21T20:14:29.766Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.ValidationV1Beta1")
@software.amazon.jsii.Jsii.Proxy(ValidationV1Beta1.Jsii$Proxy.class)
public interface ValidationV1Beta1 extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.lang.String getMessageExpression() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ValidationV1Beta1}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ValidationV1Beta1}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ValidationV1Beta1> {
        ...
        /**
         * Sets the value of {@link ValidationV1Beta1#getExpression}
        ...
        /**
         * Sets the value of {@link ValidationV1Beta1#getMessage}
        ...
        /**
         * Sets the value of {@link ValidationV1Beta1#getMessageExpression}
         * @param messageExpression messageExpression declares a CEL expression that evaluates to the validation failure message that is returned when this rule fails.
         *                          Since messageExpression is used as a failure message, it must evaluate to a string. If both message and messageExpression are present on a validation, then messageExpression will be used if validation fails. If messageExpression results in a runtime error, the runtime error is logged, and the validation failure message is produced as if the messageExpression field were unset. If messageExpression evaluates to an empty string, a string with only spaces, or a string that contains line breaks, then the validation failure message will also be produced as if the messageExpression field were unset, and the fact that messageExpression produced an empty string/string with only spaces/string with line breaks will be logged. messageExpression has access to all the same variables as the <code>expression</code> except for 'authorizer' and 'authorizer.requestResource'. Example: "object.x must be less than max ("+string(params.max)+")"
         * @return {@code this}
         */
        public Builder messageExpression(java.lang.String messageExpression) {
            this.messageExpression = messageExpression;
            return this;
        }

        /**
         * Sets the value of {@link ValidationV1Beta1#getReason}
         ...
         * @return a new instance of {@link ValidationV1Beta1}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ValidationV1Beta1 build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ValidationV1Beta1}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ValidationV1Beta1 {
        private final java.lang.String expression;
        private final java.lang.String message;
        private final java.lang.String messageExpression;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.messageExpression = software.amazon.jsii.Kernel.get(this, "messageExpression", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.messageExpression = builder.messageExpression;
        ...
        @Override
        public final java.lang.String getMessageExpression() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            if (this.getMessageExpression() != null) {
                data.set("messageExpression", om.valueToTree(this.getMessageExpression()));
            }
            ...
            struct.set("fqn", om.valueToTree("k8s.ValidationV1Beta1"));
        ...
        public final boolean equals(final Object o) {
            ...
            ValidationV1Beta1.Jsii$Proxy that = (ValidationV1Beta1.Jsii$Proxy) o;

            if (!expression.equals(that.expression)) return false;
            if (this.message != null ? !this.message.equals(that.message) : that.message != null) return false;
            if (this.messageExpression != null ? !this.messageExpression.equals(that.messageExpression) : that.messageExpression != null) return false;
        ...
        public final int hashCode() {
            ...
            result = 31 * result + (this.messageExpression != null ? this.messageExpression.hashCode() : 0);
