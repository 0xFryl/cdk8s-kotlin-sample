...
public interface ParamRefV1Alpha1 extends software.amazon.jsii.JsiiSerializable {
     ...
     * <p>
     * <code>name</code> and <code>selector</code> are mutually exclusive properties. If one is set, the other must be unset.
     */
     ...
     * <p>
     * Allowed values are <code>Allow</code> or <code>Deny</code> Default to <code>Deny</code>
     * <p>
     * Default: Deny`
     */
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ParamRefV1Alpha1> {
         ...
         * @param name <code>name</code> is the name of the resource being referenced.
         *             <code>name</code> and <code>selector</code> are mutually exclusive properties. If one is set, the other must be unset.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link ParamRefV1Alpha1#getParameterNotFoundAction}
        ...
        /**
         * Sets the value of {@link ParamRefV1Alpha1#getSelector}
