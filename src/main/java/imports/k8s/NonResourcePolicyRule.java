 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.106.0 (build e852934)", date = "2024-12-21T20:14:29.695Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.NonResourcePolicyRule")
...
public interface NonResourcePolicyRule extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    public static final class Builder implements software.amazon.jsii.Builder<NonResourcePolicyRule> {
